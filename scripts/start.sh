...
cp ./.env ${DIR}/degvabank/degvabank/settings
...
function setup_db {
	...
	echo "migrate"
	python3 ${DIR}/degvabank/manage.py migrate
...
alias runserver="python3 ${DIR}/degvabank/manage.py runserver"
alias migrate="python3 ${DIR}/degvabank/manage.py migrate"
alias makemigrations="python3 ${DIR}/degvabank/manage.py makemigrations"
alias collectstatic="python3 ${DIR}/degvabank/manage.py collectstatic"
